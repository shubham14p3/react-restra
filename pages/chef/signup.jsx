...
const ChefSignUp = (props) => {
  return (
    <div className="py-10 min-h-screen">
      <div className="flex max-w-sm mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden lg:max-w-4xl">
        <div
        ...
        <div className="w-full py-8 px-6 md:px-8 lg:w-1/2">
          ...
          <div className="mt-8">
            <button className="bg-gray-700 text-white py-2 px-4 w-full tracking-wide rounded hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
              Login
            </button>
          </div>
          <div className="mt-4 flex items-center justify-between">
